...
namespace SaveMyCollections.Data
{
    ...
    {
        public static void Initialize(SaveMyCollectionsContext context)
        {
            context.Database.Migrate();
            bool saveData = false;
            #region BoneGrades
            if (!context.BanknoteGrades.Any())
            {
                var grades = new List<BanknoteGrade> {
                new BanknoteGrade{ Code = "UNC",
                               Name = "Uncirculated",
                ...
                context.BanknoteGrades.AddRange(grades);
                saveData = true;
            }
